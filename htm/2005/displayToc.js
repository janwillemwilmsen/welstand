/*------------------------------------------------------------------- 
Author's Statement:  IE pakt het stylesheet niet, wel code in tocparas, NC, wel stylesheet niet tocparas
...
onderste var mdi was 3 en 4 
toc.document.writeln("<td valign=top><a href=\"javaScript:parent.reDisplay('" + thisNumber + "'," + thisIsExpanded + ");\"><img src=\"images/" + img + ".gif\" width=13 height=12 border=0></a></td> <td colspan=" + (nCols-thisLevel) + "><a href=\"javaScript:\parent.reDisplay('" + thisNumber + "'," + thisIsExpanded + ")\" style=\"font-family: " + fontLines + ";" + ((thisLevel<=mLevel)?"font-weight:bold":"") +  "; font-size:" + ((thisLevel<=mLevel)?mdi:sml) + "px; color: " + ((isCurrentNumber)?currentColor:normalColor) + "; text-decoration:none\">" + ((showNumbers)?(thisNumber+" "):"") + tocTab[i][1] + "</a></td></tr>");
--------------------------------------------------------------------*/
...
function reDisplay(currentNumber,currentIsExpanded) {
	toc.document.open();
	toc.document.write("<html>\n<head>\n<title>ToC</title>\n<link href=../../css/styles.css rel=stylesheet type=text/css>\n<style> A:link {font-size:11px; font-family: verdana; color:#f9f9f9; text-decoration:none;}A:visited {font-size:11px; font-family: verdana; color:#f9f9f9; text-decoration:none; }A:hover {font-size:11px; font-family: verdana;  text-decoration:underline; color:#dfaf1f;}\n</style>\n</head>\n<body background=../../img/bgmenu.gif>\n<table border=0 cellspacing=1 cellpadding=0>\n<tr>");
	...
	for (i=0; i<tocTab.length; i++) {
		...
		if (toDisplay) {
			if (i==0) {
				toc.document.writeln("\n<td colspan=" + (nCols+1) + "><a href=\"javaScript:\parent.reDisplay('" + thisNumber + "'," + thisIsExpanded + ")\" style=\"font-family: " + fontTitle + "; font-size:" + textSizes[0] + "px; color: " + titleColor + "; text-decoration:none\">" + tocTab[i][1] + "</a></td></tr>");
				for (k=0; k<nCols; k++) {
					toc.document.write("<td>&nbsp;</td>");
				}
				toc.document.write("<td width=155>&nbsp;</td></tr>");
				}
			else {
				...
				toc.document.writeln("<td valign=top><a href=\"javaScript:parent.reDisplay('" + thisNumber + "'," + thisIsExpanded + ");\"><img src=\"images/" + img + ".gif\" width=13 height=12 border=0></a></td> <td colspan=" + (nCols-thisLevel) + "><a href=\"javaScript:\parent.reDisplay('" + thisNumber + "'," + thisIsExpanded + ")\" style=\"font-family: " + fontLines + ";" + ((thisLevel<=mLevel)?"font-weight:normal":"") +  "; font-size:" + ((thisLevel<=mLevel)?mdi:sml) + "px; color: " + ((isCurrentNumber)?currentColor:normalColor) + "; text-decoration:none\">" + ((showNumbers)?(thisNumber+" "):"") + tocTab[i][1] + "</a></td></tr>");
			}
		}
	}
